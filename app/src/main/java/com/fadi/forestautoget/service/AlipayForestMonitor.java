...
public class AlipayForestMonitor {
    ...
    public static void startAlipay(Context mContext) {
        ...
        intent.setPackage("com.anjuke.android.app");
        intent.setClassName("com.anjuke.android.app", "com.anjuke.android.app.common.activity.MainTabPageActivity");
    ...
    public static void enterForestUI(AccessibilityNodeInfo nodeInfo) {
        ...
        if (nodeInfo != null) {
            // 找到界面中蚂蚁森林的文字
            List<AccessibilityNodeInfo> list = nodeInfo.findAccessibilityNodeInfosByText("找小区");
    ...
    public static void policy(AccessibilityNodeInfo nodeInfo, String packageName, String className) {
         ...
         * 蚂蚁森林界面
         */
        if (packageName.equals("com.anjuke.android.app") ) {
